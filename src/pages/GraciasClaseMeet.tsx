...
const GraciasClaseMeet = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-12 md:py-20 bg-gradient-to-br from-[#25D366]/15 via-black to-[#25D366]/5 border-b-4 border-[#25D366] sticky top-0 z-10" style={{ backdropFilter: 'blur(10px)' }}>
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-6">
            ...
            <div className="bg-gradient-to-r from-[#25D366]/20 to-[#25D366]/5 border-2 border-[#25D366] rounded-2xl p-6 md:p-8 mb-6">
              <div className="flex items-center justify-center gap-3 mb-4">
                <AlertTriangle className="w-8 h-8 text-[#25D366] animate-pulse" />
                <h3 className="text-xl md:text-2xl font-bold text-[#25D366]">
                  PASO CRÍTICO #1
                </h3>
              </div>
              <p className="text-lg md:text-xl text-white text-center mb-2 leading-relaxed">
          ...
          <div className="text-center">
            <a 
              ...
              className="inline-block w-full md:w-auto mb-4"
            >
              <Button 
                className="w-full md:w-auto md:min-w-[500px] bg-[#25D366] hover:bg-[#20BD5A] text-white text-xl md:text-2xl px-12 md:px-16 py-7 md:py-9 rounded-2xl font-bold shadow-[0_6px_25px_rgba(37,211,102,0.5)] hover:shadow-[0_10px_40px_rgba(37,211,102,0.7)] transition-all duration-300 hover:scale-[1.02] animate-pulse"
                style={{ animationDuration: '2s' }}
              >
                <svg className="w-8 h-8 md:w-10 md:h-10 mr-3" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid md:grid-cols-2 gap-4 max-w-3xl mx-auto text-sm md:text-base">
      ...
      <section className="py-12 md:py-16 bg-background border-b border-white/10">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8">
            {/* EMAIL */}
            <div className="bg-gradient-to-br from-primary/15 to-background border-2 border-primary/30 rounded-xl p-6 md:p-8">
              ...
              <div className="bg-red-500/10 border border-red-500/40 rounded-lg p-4 mb-4">
                <p className="text-sm text-red-400 font-semibold mb-1">⚠️ Revisa también SPAM</p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <p className="text-white/80 text-sm">Recordatorios antes del taller</p>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <p className="text-white/80 text-sm">Material de preparación</p>
                </div>
              </div>
            </div>

            {/* DETALLES DEL TALLER */}
            <div className="bg-gradient-to-br from-[#D4AF37]/15 to-background border-2 border-[#D4AF37]/30 rounded-xl p-6 md:p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 bg-white/5 rounded-lg p-4">
                  <Calendar className="w-8 h-8 text-[#D4AF37] flex-shrink-0" />
                  <div>
                    <p className="text-sm text-white/70">Día</p>
                    <p className="text-lg font-semibold text-white">Este Miércoles</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-white/5 rounded-lg p-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-[#D4AF37]">1:00 PM</p>
                    <p className="text-xs text-white/60">(horario Colombia)</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-white/5 rounded-lg p-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-white">Google Meet</p>
                    <p className="text-xs text-white/60">(enlace por email)</p>
                  </div>
                </div>
              </div>
            </div>
