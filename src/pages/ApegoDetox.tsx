...
const ApegoDetox = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-['Poppins',sans-serif] overflow-x-hidden">
      ...
      <a
        href="https://wa.me/573001681053?text=Hola%2C%20estoy%20interesada%20en%20comprar%20Apego%20Detox%20pero%20tengo%20una%20pregunta"
        target="_blank"
        rel="noopener noreferrer"
        className="group fixed bottom-6 md:bottom-8 right-6 md:right-8 z-50"
      >
        {/* Tooltip */}
        <div className="hidden md:block absolute right-full top-1/2 transform -translate-y-1/2 mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div className="relative bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg text-sm font-semibold whitespace-nowrap">
            ¿Tienes preguntas? Escríbenos
            {/* Flecha */}
            <div className="absolute right-[-8px] top-1/2 transform -translate-y-1/2 border-l-8 border-l-white border-y-8 border-y-transparent"></div>
          </div>
        </div>

        {/* Botón */}
        <div className="relative w-16 h-16 md:w-20 md:h-20 bg-[#25D366] rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.6)] flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-[0_6px_30px_rgba(37,211,102,0.8)] animate-bounce">
          {/* SVG WhatsApp */}
